...
t = tiledlayout(4,1, "TileSpacing", "tight"); title(t,'Effect of Spikes in Sinogram','FontSize', 24); xlabel(t, 'IFT = Inverse Fourier Transform, CB = Convolution Backprojection, IRT = Inverse Radon Transform', 'FontSize', 18)
